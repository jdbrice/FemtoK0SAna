...
env.Program( target="bin/pairAna.app", source=[ "modules/StarClassLibrary/StDcaGeometry.cc", "modules/StarClassLibrary/StHelix.cc", "modules/StarClassLibrary/StPhysicalHelix.cc", "modules/FemtoDstFormat/DictionaryFemtoDst.cpp", "Engine.cpp"] )
